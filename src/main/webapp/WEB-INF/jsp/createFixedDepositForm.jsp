...
<body>
	<form name="createFixedDepositForm" method="POST"
		...
		<table align="left" style="padding-left: 300px;">
			<tr>
				<td
					style="font-family: 'arial'; font-size: 12px; font-weight: bold" align="right"><a href="${pageContext.request.contextPath}/j_spring_security_logout">Logout</a></td>
			</tr>
			<tr>
				<td
			...
			<tr align="left">
				<td>
					<table class="border" cellpadding="10">
						<tr>
							<td class="td"><b>Customer Price - $/1000units (USD):</b></td>
						...
						<tr>
							<td class="td"><b>Length(cm) (Along the zipper side):</b></td>
							<!-- value="${requestScope.fixedDepositDetails.email}" -->
							<td class="td"><input type="text" name="length" value="0"  /><font
								style="color: #C11B17;"><!-- <c:out value="${requestScope['error.email']}"/> --> </font></td>
						</tr>
						<tr>
							<td class="td"><b>Width(cm):</b></td>
							<!-- value="${requestScope.fixedDepositDetails.email}" -->
							<td class="td"><input type="text" name="width" value="0"  /><font
								style="color: #C11B17;"><!-- <c:out value="${requestScope['error.email']}"/> --> </font></td>
						</tr>
						<tr>
							<td class="td"><b>Email (optional):</b></td>
							<td class="td"><input type="text" name="email" value="${requestScope.fixedDepositDetails.email}" /><font
								style="color: #C11B17;"><c:out value="${requestScope['error.email']}"/></font></td>
						</tr>
						<tr>
						<td class="td"><div id="notes">Note: 1unit = 1bag unless otherwise specified</div></td></tr>
					</table>
				</td>
			</tr>
			<tr align="left">
